<%-- 
    ...
    Created on : 13 jun. 2023, 16:49:07
    Author     : Admin
--%>
                ...
                <section class="content">
                    <div class="box">
                        <div class="box-header with-border">
                            <i class="fa fa-edit"></i> <h3 class="box-title">Actualizar Datos Cargo</h3>  
                        </div>
                        <form class="form-horizontal" action="srvCargo?accion=actualizar_cargo" method="post">
                            <input type="hidden" name="hCodigo_cargo" value="${cargo.codigo}">
                            <div class="box-body">
